...
* commit, ci [number] - do commit to vcs with the information on the specified error

Shelltoad supports 'magicfind' in all comments: 
You don't need to type all whole error id - just last three numbers is enough.
